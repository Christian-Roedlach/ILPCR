...
#cfg_preset="-pcfg ../cfg/customPreset5cuTest.cfg"
#preset=custom5cuTest
preset=fpfh_5_fpfh_fgr_gpu
c_preset=p6a
cfg_preset="-p ${preset}"
target_file_source="20231121_fhtw_hallway_groundplane_tf"
target_file_lidar="../../files/${target_file_source}.pcd"
target_file="../../files/feature_desc/${target_file_source}_${preset}.pcd"
source_file_src="20240416_fhtw_stairs_${c_preset}_"
